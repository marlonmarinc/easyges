...
CREATE TABLE IF NOT EXISTS productos (
    ...
    -- Atributos especÃ­ficos moto-gear
    talla            VARCHAR(20),
    color            VARCHAR(50),
...
-- ============================================
-- TABLA: datos de la empresa (facturaciÃ³n)
-- ============================================
...
-- ============================================
-- TABLA: consecutivos para facturaciÃ³n
-- ============================================
...
('Efectivo', 'efectivo', 1),
('Tarjeta DÃ©bito', 'tarjeta', 2),
('Tarjeta CrÃ©dito', 'tarjeta', 3),
('Transferencia', 'transferencia', 4),
('CrÃ©dito 30 dÃ­as', 'credito', 5),
('CrÃ©dito 60 dÃ­as', 'credito', 6);
